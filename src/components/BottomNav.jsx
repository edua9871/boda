...
export default function BottomNav({ activeSection, scrollTo }) {
  ...
  return (
    <nav className="bottom-nav fixed bottom-0 left-0 w-full glass flex items-center px-2 py-3 z-50 shadow-[0_-20px_40px_rgba(0,0,0,0.04)] border-t border-white/20 overflow-x-auto">
